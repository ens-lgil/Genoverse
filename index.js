...
require(__dirname + '/js/Track/Model/File/LRGBED.js');
require(__dirname + '/js/Track/Model/File/LRGDIFF.js');
...
require(__dirname + '/js/Track/library/File/LRGBED.js');
require(__dirname + '/js/Track/library/File/LRGDIFF.js');
